...
# スコア用のモデルを直接ResNet50として定義
score_net = models.resnet50(weights=None)
num_features = score_net.fc.in_features
score_net.fc = nn.Linear(num_features, 2)  # クラス数は2
